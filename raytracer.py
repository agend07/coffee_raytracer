...
# source: http://www.lshift.net/blog/2008/10/29/toy-raytracer-in-python
...
if __name__ == '__main__':
    ...
    for y in range(6):
        s.addObject(Sphere(Point(-2 + y * 1, 4.3, -5 + y), 0.4),
                    SimpleSurface(baseColour = (y / 3.0, 1 - y / 3.0, y/3)))
